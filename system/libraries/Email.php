...
//	var	$smtp_host		= "mail.dane.gov.co";		// SMTP Server.  Example: mail.earthlink.net
//	var	$smtp_user		= "";		// SMTP Username
//	var	$smtp_pass		= "";		// SMTP Password
//	var	$smtp_port		= "26";		// SMTP Port
	var	$smtp_host		= "192.168.1.98";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "aplicaciones@dane.gov.co";		// SMTP Username
	var	$smtp_pass		= "Ou67UtapW3v";		// SMTP Password
