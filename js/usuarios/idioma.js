$(function(){
        ...
        $("#resultado").load(base_url + "usuarios/listaIdioma");//lista de datos
        ...
        $("#cual").bloquearNumeros().maxlength(20);
	...
	$("#btnIdioma").click(function(){		
		...
		if ($("#formIdioma").valid() == true){
			...
			$("#div_cargando").css("display", "inline");
				...
				$.ajax({
					type: "POST",
					url: base_url + "usuarios/guardaIdioma",					
					...
					//data=utf8_decode(data);
						...
						{	
                                                        ...
                                                        bootbox.alert("Se guardo la informaci\u00F3n correctamente.", function() {
                                                                ...
                                                                $('#btnIdioma').removeAttr('disabled');   

                                                                var url = base_url + "usuarios/idiomas";
