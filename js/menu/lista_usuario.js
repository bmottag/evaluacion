$(document).ready(function () {
    ...
    jQuery('#listPersonasAsis').jqGrid({
        url: generateGetURL('menu/buscarPersonas/', data),
        editurl: base_url + 'gh_asistencia/edit',
        datatype: 'json',
        mtype: 'POST',
        colNames: ['Cedula', 'Apellidos', 'Nombre(s)', 'Correo electrónico', 'Usuario', 'Asignar Jefe', 'Roles'],
        colModel: [
            ...
            {name: 'jefe', index: 'jefe', align: 'center', resizable: false, search: false, sortable: false, width: 50},
            {name: 'roles', index: 'roles', align: 'center', resizable: false, search: false, sortable: false, width: 40}
        ],
        autowidth: true,
        height: 'auto',
        multiselect: false,
